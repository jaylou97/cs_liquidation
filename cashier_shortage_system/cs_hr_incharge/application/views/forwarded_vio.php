			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="portlet light" style="padding-bottom: 0px !important;">
						<div class="portlet-title">
							<div class="caption">								
								<span class="caption-subject uppercase" style="color: black !important; font-size: 18px;">Forwarded Vio. Form</span>
							</div>					
						</div>
				...
				<div class="col-md-9 col-sm-12">
					...
					<div class="portlet light" style="">
						<div class="portlet-title">
							<div class="caption">								
								<span class="caption-subject uppercase" style="color: black !important; font-size: 18px;">Forwarded Violation data table</span>
							</div>
...
{  
	...
	else
	{
		$.ajax(
		{
			url: "<?php echo site_url('main_controller/forwarded_vio_con');?>",
			method:"POST",

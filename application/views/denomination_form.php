      ...
      <div class="row">
       ...
       <div class="portlet light">
            <div class="portlet-title">
              <div class="caption">
                <span class="caption-subject uppercase">DENOMINATION FORM</span>
                            ...
                            <form name="add_name" id="add_name">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="background: ;">
                                            <div style="background: red; padding: 0px;" class="col-md-8">                                                
                                                <input type='text'  class="form-control input-sm input_br" name="input_br[]" id='input_br_1' style="font-size: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: ;">
                                            <div style="background: red; padding: 0px;" class="col-md-8">                                                
                                                <input type='text'  class="form-control input-sm input_br" name="input_br[]" id='input_br_2' style="font-size: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: ;">
                                            <div style="background: red; padding: 0px;" class="col-md-8">                                                
                                                <input type='text'  class="form-control input-sm input_br" name="input_br[]" id='input_br_3' style="font-size: 12px;">
                                     ...
                                     <tr>
                                        ...
                                        <td style="background: ;">
                                            <div style="background: red; padding: 0px;" class="col-md-8">                                                
                                                <input type='text'  class="form-control input-sm input_br" name="input_br[]" id='input_br_4' style="font-size: 12px;">
                                     ...
                                     <tr>
                                        ...
                                        <td style="background: ;">
                                            <div style="background: red; padding: 0px;" class="col-md-8">                                                
                                                <input type='text'  class="form-control input-sm input_br" name="input_br[]" id='input_br_5' style="font-size: 12px;">
...
<div class="modal fade" id="invalid_login_insert_modal" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
<div class="modal fade" id="invalid_subordinates_insert_modal" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
<div class="modal fade bs-modal-sm" id="managers_key_modal" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-sm" >
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Managers Key</h4>
      </div>
        <div class="modal-body">
          ...
          <div class="table-responsive" id="sampleTable"  style="max-height: calc(100vh - 210px); overflow-y: auto;">            
          </div>
        </div>
...
<script type="text/javascript">
    ...
    {
        'ajax':'<?php echo site_url('main_controller/cs_data_con');?>',
        "order": [[ 5, "desc" ]],
        'columnDefs': [
    ...
    $(document).on('keydown', '.name', function() 
    {
        ...
        $( '#'+id ).autocomplete(
        {
            ...
            {
                $.ajax({
                url: "<?php echo site_url('main_controller/search_name');?>",
                type: 'post',
                dataType: "json",
                data: {
  ...
  $("#login").click(function()
  {
      ...
      $.ajax({
        url:"<?php echo site_url('main_controller/validate_managers_key')?>",
        method:"POST",
        data:$('#add_name').serialize()+ '&username='+username+ '&password='+password,
        success:function(data)
        {
          ...
          else
          {
                ...
                if(blank[0].error == "Subordinates doesnt matched!")
                {
                  alert('Subordinates doesnt matched!');
                  //$('#invalid_subordinates_insert_modal').modal('show');
                  //$('#managers_key_modal').modal('hide');
                }
                else 
                {
                  alert('Incorrect username/password!');
                  //$('#invalid_login_insert_modal').modal('show');
                  //$('#managers_key_modal').modal('hide');
                }
        ...
        { 
          for (i = 0; i < blank.length; i++) 
          {
            ...
            else if(blank[i].error == "date")
            {
              ...
              $('#date_'+indx).css({"background-color":"#9f0707","color":"white"});
              duplicate++;
            }
          }

            if(duplicate == blank.length)
            {

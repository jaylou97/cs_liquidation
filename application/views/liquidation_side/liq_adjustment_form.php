        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    ...
                    <div class="portlet-body row" id="divbody_adjustment_table">
...
<!-- ===========================================ADJUSMENT FORM========================================= -->
                <div class="column">
                     <div class="form-body" id="form_body">
                            ...
                            <table class="table table-striped table-bordered table-hover display" style="color: black; font-size: 12px;">
                                ...
                                <form name="cash_form" id="cash_form">
                                    <tbody>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Transaction No.">
                                            </td>
                                            <td>
                                                <input type="text" class="input-sm data" id="tr_no" disabled="" placeholder="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Sales Date">
                                            </td>
                                            <td>
                                                <input type="date" class="input-sm data" id="filter_date" onchange="get_deptamount_js()" placeholder="" value="<?php echo date('Y-m-d')?>">

                                                <!-- ========================important code using min date================================================ -->
                                                <!-- <input type="date" min="<?php //echo date('Y-m-d', strtotime('-1 day'))?>" class="input-sm data" id="filter_date" placeholder="" value="<?php //echo date('Y-m-d')?>"> -->
                                                <!-- ====================================================================================================== -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Business Unit">
                                                <input type="text" hidden class="input-sm data" disabled="" id="bunit_code" placeholder="">
                                            </td>
                                            <td>
                                                <select class="input-sm data" onchange="get_bunitcode_js()" id="bunit_list" style="height: 35px;">
                                        ...
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Department">
                                                <input type="text" hidden class="input-sm txt" id="dept_code" disabled="" placeholder="">
                                            </td>
                                            <td>
                                                <select class="input-sm data" onchange="get_department_js()" id="liq_department" style="height: 35px;">
                                        ...
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Amount">
                                            </td>
                                            <td>
                                                <input type="text" class="input-sm data" disabled="" id="dept_amount" placeholder="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Adjustment Amount">
                                            </td>
                                            <td>
                                                <input type="text" class="input-sm data" autocomplete="off" id="adjustment_amount" onchange="calculate_gtadjusment_js()" onkeyup="calculate_gtadjusment_js()" placeholder="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Grand Total">
                                            </td>
                                            <td>
                                                <input type="text" class="input-sm data" id="gt_adjustment" disabled="" placeholder="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="35%">
                                                <input type="text" class="input-sm txt" id="" disabled="" value="Reason">
                                            </td>
                                            <td>
                                                <textarea type="text" style="text-align: left;" class="input-sm data" id="adjustment_reason" placeholder=""></textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </form>
                        ...
                        <footer id="liq_adjustment_footer">
                          <div id="footer-content">
                            <center>
                             <button type="button" id="" class="btn btn-primary waves-effect" onclick="reset_amount_adjustment_js()">RESET</button>
                             <button type="button" id="" class="btn btn-warning waves-effect" onclick="submit_amount_adjustment_js()">SUBMIT</button>
                            </center>
                          </div>
                        </footer>
                </div>
        ...
        <div class="row">
            ...
            <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject uppercase">adjusted list</span>
                        </div>              
                    </div>
                    <div class="portlet-body" id="divbody_adjusted_table">
...
<!-- =========================================================VIEWING FORM====================================================================== -->
                            <table class="table table-striped table-bordered table-hover display" id="adjusted_table" style="color: black; font-size: 12px;">
                                ...
                                <form name="adjustment_viewing_form" id="adjustment_viewing_form">
                                    <tbody id="adjustment_viewing_tbody">
...
// ==================================DISABLED SPECIAL CHARACTER==========================================
        $('#adjustment_amount').on('change keyup keypress keydown click input', function() {
          var sanitized = $(this).val().replace(/[^0-9 .-]/g, '');
          $(this).val(sanitized);
          calculate_gtadjusment_js();
        });
// ======================================================================================================

// ======================disabled previous date -1=========================================
      /* $(function(){
        var dtToday = new Date();

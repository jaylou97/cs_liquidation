          ...
          ?>
              ...
              <ul>
               <!--  <li id="dashboard">
                ...
                <li id="den_form">
                  <a href="<?php echo site_url('main_controller/denomination_form')?>">
                        Denomination Form             
                  </a>
                 <!--  <a href="<?php echo base_url() ?>liq_domination_route">
                   Pending Denomination
                  </a> -->
                </li> 
                <li class="" id="deduction">
                  <a href="<?php echo site_url('main_controller/deduction_con')?>">
                    Deductions        
                  </a>
                </li> 
                <li class="" id="deduction_for">
                  <a href="<?php echo site_url('main_controller/deduction_for_con')?>">
                    Deductions Forwarded      
                  </a>
                </li>
                <li class="" id="">
                  <a href="<?php echo base_url() ?>liq_adjustment_route">
                    Adjustment      
                  </a>
                </li> 
                <li class="" id="demo_id">
                 ...
                 <!--  <a href="<?php echo base_url() ?>cashier_linkaccess_route">
                    Cashier Link/Access      
                  </a> -->
                </li> 
              <!--   <li class="" id="report_id">
